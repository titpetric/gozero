...
// Conditions, the L1 rung: if / else if / else over braced statement
// lists. The condition is deliberately not an expression: it is a
// name, a field path, or a call, and the compiler checks it is bool.
// There is no init clause and no operator; docs/design/conditions.md
// records what the fuller forms cost.
//
